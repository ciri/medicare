                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                        ...
                                        <%
                                            if(!td.isNewmeasurementrequired()) {
                                        %>
                                        ...
                                        %>
                                            This task requires a <a href="addmeasurement.jsp?m=<%= td.getPrescription().getMedication().getMeasurementrequired() %>">
                                                <%= td.getPrescription().getMedication().getMeasurementrequired() %>
                                            measurement</a> first!
                                        <%
                                        }
                                        %>
